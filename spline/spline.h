...
#define DELTA_PRESENCE      0x80000000
#define DELTA_COUNTER_MASK  0x7FFFFFFF
#define DELTA_COUNTER(x)    ((x&(DELTA_COUNTER_MASK)))
#define IS_DELTA_PRESENCE(x)    ((x&(DELTA_PRESENCE)))

// spline interpolation
typedef double splineType;
...
public:
	...
	splineType operator() (double x) const;
	splineType cachedAt(int x) const;
};
